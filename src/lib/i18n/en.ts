...
export const en = {
  ...
  feed: {
    ...
    online: "Online",
    offline: "Offline",
    offlineCached: "Offline — showing cached data. It will refresh when you're back online.",
    offlineNoCache: "No cached data for this view. Reconnect to load the feed.",
  ...
  onboarding: {
    ...
    subtitle:
      "Discover open-source repos with real business potential. Select your interests for a personalized feed — anything from music to machine learning.",
    skip: "Skip",
    continue: "Continue",
    noneSelected: "No interests selected",
  ...
  feedback: {
    ...
    whyTitle: "Why?",
    whyLikeTitle: "What did you like?",
    whyDislikeTitle: "What didn't work for you?",
    skipReason: "Skip",
    submitReason: "Submit",
    customPlaceholder: "Tell us more (optional)…",
    thanksNote: "Thanks — this improves your feed.",
    likeReasons: [
